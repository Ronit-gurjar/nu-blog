...
import { ThemeToggle } from "../dashboard/theme-toggel";
import {
  LoginLink,
  RegisterLink,
    ...
    <div className="flex flex-col">
      ...
      <section className="relative flex items-center justify-center">
        ...
        <Image
          ...
          className="relative object-cover w-full border border-primary rounded-lg shadow-2xl lg:rounded-2xl hidden dark:block"
          priority
        />
        <Image
          src={HeroLightImage}
          alt="Light theme hero image"
          className="relative object-cover w-full border-2 border-primary rounded-lg shadow-2xl lg:rounded-2xl block dark:hidden"
          priority
        />
